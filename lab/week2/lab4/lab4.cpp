...
///////////////////////////////////////////////////////////////////////////////
// Use encoding to encode all characters from in, writing the encoded
// characters to out.

void huffmanEncode(istream &in, map<char, string>& encoding, ostream &out)
{

  // TODO: your code here
  BitWriter toConvert(out);
  char c;
  while (in.get(c))
    {
      //in.get(c);
      toConvert.write(encoding[c]);
    }
}
